							...
							<div class="register-form form-item ">
								...
								<form method="POST" action="{{ route('register') }}" class="form-stl" name="frm-login">
									...
									<fieldset class="wrap-input item-width-in-half left-item ">
										...
										<input type="text" id="frm-reg-pass" placeholder="Password" name="password" required autocomplete="new-password">
									</fieldset>
                                    ...
                                    <a class="link-function left-position" href="{{ route('login') }}" title="Forgotten password?">Already have an account?</a>
								</form>
							</div>											
						</div>
